...
class HUD   
  ...
  #removed viewport1
    ...
    if $Trainer.party.size == 0   
      ...
      #left side
      #pokemon 1 
        [@currentTexts[0],120,0+5,2,baseColor,shadowColor],
        [@currentTexts[1],120,30+5,2,baseColor,shadowColor],
      #pokemon 2  
        [@currentTexts[2],120,64+5,2,baseColor,shadowColor],
        [@currentTexts[3],120,96+5,2,baseColor,shadowColor],
      #pokemon 3 
        [@currentTexts[4],120,128+5,2,baseColor,shadowColor],
        [@currentTexts[5],120,160+5,2,baseColor,shadowColor],
      #pokemon 4  
        [@currentTexts[6],120,192+5,2,baseColor,shadowColor],
        [@currentTexts[7],120,224+5,2,baseColor,shadowColor],
      #pokemon 5  
        [@currentTexts[8],120,256+5,2,baseColor,shadowColor],
        [@currentTexts[9],120,288+5,2,baseColor,shadowColor],
      #pokemon 6  
        [@currentTexts[10],120,320+5,2,baseColor,shadowColor],
        [@currentTexts[11],120,353+5,2,baseColor,shadowColor],
      #right side
        [@currentTexts[12],812,23,2,baseColor,shadowColor],
        [@currentTexts[13],812,218,2,baseColor,shadowColor],
        [@currentTexts[14],812,258,2,baseColor,shadowColor],
    ...
    if $Trainer.party.size == 0
      ...
      ret[0] = _INTL("{1}",$Trainer.party[0].name)
      ret[1] = _INTL("LV:  {1}",$Trainer.party[0].level)      
      ret[2] = _INTL(" ")
      ret[3] = _INTL(" ")
      ret[4] = _INTL(" ")
      ret[5] = _INTL(" ")
      ...
      ret[15] = _INTL("$:{1}",$Trainer.money)
      ret[16] = _INTL("Badges:{1}",$Trainer.numbadges)
    elsif $Trainer.party.size == 2 
      ret[0] = _INTL("{1}",$Trainer.party[0].name)
      ret[1] = _INTL("LV:  {1}",$Trainer.party[0].level)
      ret[2] = _INTL("{1}",$Trainer.party[1].name)
      ret[3] = _INTL("LV:  {1}",$Trainer.party[1].level)
      ret[4] = _INTL(" ")
      ret[5] = _INTL(" ")
      ret[6] = _INTL(" ")
      ret[7] = _INTL(" ")
      ...
      ret[15] = _INTL("$:{1}",$Trainer.money)
      ret[16] = _INTL("Badges:{1}",$Trainer.numbadges)
    elsif $Trainer.party.size == 3 
      ret[0] = _INTL("{1}",$Trainer.party[0].name)
      ret[1] = _INTL("LV:  {1}",$Trainer.party[0].level)
      ret[2] = _INTL("{1}",$Trainer.party[1].name)
      ret[3] = _INTL("LV:  {1}",$Trainer.party[1].level)
      ret[4] = _INTL("{1}",$Trainer.party[2].name)
      ret[5] = _INTL("LV:  {1}",$Trainer.party[2].level)
      ret[6] = _INTL(" ")
      ret[7] = _INTL(" ")
      ret[8] = _INTL(" ")
      ret[9] = _INTL(" ")
      ...
      ret[4] = _INTL("{1}",$Trainer.party[2].name)
      ret[5] = _INTL("LV:  {1}",$Trainer.party[2].level)
      ret[6] = _INTL("{1}",$Trainer.party[3].name)
      ret[7] = _INTL("LV:  {1}",$Trainer.party[3].level) 
      ret[8] = _INTL(" ")
      ret[9] = _INTL(" ")
      ret[10] = _INTL(" ")
      ret[11] = _INTL(" ")
      ...
      ret[6] = _INTL("{1}",$Trainer.party[3].name)
      ret[7] = _INTL("LV:  {1}",$Trainer.party[3].level)
      ret[8] = _INTL("{1}",$Trainer.party[4].name)
      ret[9] = _INTL("LV:  {1}",$Trainer.party[4].level)
      ret[10] = _INTL(" ")
      ret[11] = _INTL(" ")
      ret[12] = _INTL("Name:{1}",$Trainer.name)
      ret[13] = _INTL("Seen:{1}",$Trainer.pokedexSeen)
      ...
      ret[8] = _INTL("{1}",$Trainer.party[4].name)
      ret[9] = _INTL("LV:  {1}",$Trainer.party[4].level)
      ret[10] = _INTL("{1}",$Trainer.party[5].name)
      ret[11] = _INTL("LV:  {1}",$Trainer.party[5].level)
      ret[12] = _INTL("Name:{1}",$Trainer.name)
      ret[13] = _INTL("Seen:{1}",$Trainer.pokedexSeen)
      ret[14] = _INTL("Owned:{1}",$Trainer.pokedexOwned)
      ret[15] = _INTL("$:{1}",$Trainer.money)
