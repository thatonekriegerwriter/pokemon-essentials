...
[:GROWTHMULCH,1,[:NOMELBERRY,2],[:FRESHWATER,1], true],
[:DAMPMULCH,1,[:DURINBERRY,2],[:FRESHWATER,1], true],
[:STABLEMULCH,1,[:BELUEBERRY,2],[:FRESHWATER,1], true],
[:GOOEYMULCH,1,[:NOMELBERRY,2],[:REDAPRICORN,1], true],
