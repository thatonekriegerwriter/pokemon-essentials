...
RECIPEMART2=[
[:TM93,1,[:STARPIECE,1],nil, true],
[:TM86,1,[:STARPIECE,1],nil, true],
[:TM87,1,[:STARPIECE,1],nil, true],
[:TM35,1,[:STARPIECE,1],nil, true],
[:TM30,1,[:STARPIECE,1],nil, true],
[:TM22,1,[:STARPIECE,1],nil, true],
[:TM24,1,[:STARPIECE,1],nil, true],
[:TM02,1,[:STARPIECE,1],nil, true],
[:TM10,1,[:STARPIECE,1],nil, true],
[:TM64,1,[:STARPIECE,1],nil, true],
[:TM62,1,[:STARPIECE,1],nil, true],
[:TM81,1,[:STARPIECE,1],nil, true],
[:TM92,1,[:STARPIECE,1],nil, true],
[:TM38,1,[:STARPIECE,1],nil, true],
[:TM29,1,[:STARPIECE,1],nil, true],
[:TM23,1,[:STARPIECE,1],nil, true],
[:TM46,1,[:STARPIECE,1],nil, true],
[:TM48,1,[:STARPIECE,1],nil, true],
[:TM18,1,[:STARPIECE,1],nil, true],
[:TM17,1,[:STARPIECE,1],nil, true],
[:TM27,1,[:STARPIECE,1],nil, true],
[:TM04,1,[:STARPIECE,1],nil, true],
[:TM43,1,[:STARPIECE,1],nil, true],
[:TM36,1,[:STARPIECE,1],nil, true],
[:TM37,1,[:STARPIECE,1],nil, true],
[:TM15,1,[:STARPIECE,1],nil, true],
[:TM37,1,[:STARPIECE,1],nil, true],
[:TM48,1,[:STARPIECE,1],nil, true],
[:TM59,1,[:STARPIECE,1],nil, true],
[:TM71,1,[:STARPIECE,1],nil, true],
[:TM75,1,[:STARPIECE,1],nil, true],
[:TM08,1,[:STARPIECE,1],nil, true],
[:TM76,1,[:STARPIECE,1],nil, true],
[:TM70,1,[:STARPIECE,1],nil, true],
[:TM87,1,[:STARPIECE,1],nil, true],
[:TM78,1,[:STARPIECE,1],nil, true],
[:TM28,1,[:STARPIECE,1],nil, true],
[:TM01,1,[:STARPIECE,1],nil, true],
[:TM96,1,[:STARPIECE,1],nil, true],
[:TM98,1,[:STARPIECE,1],nil, true],
[:TM12,1,[:STARPIECE,1],nil, true],
[:TM99,1,[:STARPIECE,1],nil, true]
]
...
class TradingMart2Scene
  ...
  def initialize
    ...
    @sprites["Item_icon"].setBitmap(pbItemIconFile(getID(PBItems,RECIPEMART2[@item][0])))
    ...
    def input
      ...
      when 3
        ...
        if $game_variables[CRAFTVAR][@item]
            ...
            @sprites["Item_1_icon"].setBitmap(RECIPEMART2[@item][2]? pbItemIconFile(getID(PBItems,RECIPEMART2[@item][2][0])) : "") # Vendily
            @sprites["Item_2_icon"].setBitmap(RECIPEMART2[@item][3]? pbItemIconFile(getID(PBItems,RECIPEMART2[@item][3][0])) : "") # Vendily
        ...
        when 2 
          if $game_variables[CRAFTVAR][@item]
            if $PokemonBag.pbQuantity(@mat1)<@cost1 || (@mat2!=-1 && $PokemonBag.pbQuantity(@mat2) <@cost2) #Seth Edited 
              ...
              self.text
              Kernel.pbMessage(_INTL("{1} {2}'s were traded for each other.", @amount, PBItems.getName(getID(PBItems,RECIPEMART2[@item][0]))))
            end
          else
