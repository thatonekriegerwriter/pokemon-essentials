...
class TradingMart3Scene
  ...
  def initialize
    ...
    @sprites["Item_icon"].setBitmap(pbItemIconFile(getID(PBItems,RECIPEMART3[@item][0])))
    ...
    def input
      ...
      when 3
        ...
        if $game_variables[CRAFTVAR][@item]
            ...
            @sprites["Item_1_icon"].setBitmap(RECIPEMART3[@item][2]? pbItemIconFile(getID(PBItems,RECIPEMART3[@item][2][0])) : "") # Vendily
            @sprites["Item_2_icon"].setBitmap(RECIPEMART3[@item][3]? pbItemIconFile(getID(PBItems,RECIPEMART3[@item][3][0])) : "") # Vendily
        ...
        when 2 
          if $game_variables[CRAFTVAR][@item]
            if $PokemonBag.pbQuantity(@mat1)<@cost1 || (@mat2!=-1 && $PokemonBag.pbQuantity(@mat2) <@cost2) #Seth Edited 
              ...
              self.text
              Kernel.pbMessage(_INTL("{1} {2}'s were traded for each other.", @amount, PBItems.getName(getID(PBItems,RECIPEMART3[@item][0]))))
            end
          else
